...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Presentation.title'
        db.add_column('presentations_presentation', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Presentation.title'
        db.delete_column('presentations_presentation', 'title')
