...
STATIC_ROOT = os.path.join(PROJECT_PATH, 'django_toronto', 'static')
...
STATICFILES_DIRS = (
    os.path.join(PROJECT_PATH, 'django_toronto', 'static-media'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "pages.context_processors.page_settings",
)
